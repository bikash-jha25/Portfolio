        ...
        <div className="what-box-in">
          ...
          <div className="what-content what-noTouch" ref={(el) => setRef(el, 0)}>
            ...
            <div className="what-content-in">
              ...
              <p>
                Building end-to-end scalable web applications with modern
                JavaScript, clean APIs, and robust database architecture.
              </p>
          ...
          <div className="what-content what-noTouch" ref={(el) => setRef(el, 1)}>
            ...
            <div className="what-content-in">
              ...
              <p>
                500+ problems solved on LeetCode &amp; GFG. Strong in Graphs,
                Trees, Dynamic Programming, Greedy and Binary Search.
              </p>
              <h5>Skillset &amp; tools</h5>
              <div className="what-content-flex">
